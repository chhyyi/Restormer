...
#  
# **new features**:
# * on-the-fly aberration -> too slow for restormer... Let's just make a 
...
# %% save 1gt - 10abrr paired dataset.
...
train_path = Path("./shared/mpmneuron_3dpsf/train/")
...
# %%
import yaml
with open('./shared/mpmneuron_3dpsf/dataset_config.yaml', 'w') as f:
...
with open('./shared/mpmneuron_3dpsf/train_files.csv', 'w', newline='') as f:
    writer = csv.writer(f)
    writer.writerows(train_files)
# %% save val dataswet
test_path = Path("./shared/mpmneuron_3dpsf/test/")
...
# %%
with open('./shared/mpmneuron_3dpsf/test_files.csv', 'w', newline='') as f:
    writer = csv.writer(f)
